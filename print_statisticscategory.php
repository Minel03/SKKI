...
<div id="content">
    ...
    <hr class="dashhr">
    <h3 style="font-family: Arial; font-weight: normal; margin-bottom: -20px;">Category: <?php echo $category; ?></h3>
    ...
    <table>
        ...
        <tr style="text-align: center; font-family: Arial; font-weight: normal;">
            <?php
            $sql2 = "SELECT * FROM inventory WHERE category = '$category'";
    ...
    <?php
    $sql1 = "SELECT *, SUM(price) AS price, COUNT(*) AS item_count FROM inventory WHERE condition_bad <> 0 AND category = '$category'";
    ...
    if ($result1->num_rows > 0) {
        ...
        while ($row1 = $result1->fetch_assoc()) {
            $productname1 = $row1['product_name'];
    ...
    $sql3 = "SELECT * FROM inventory WHERE condition_bad <> 0 AND category = '$category'";
